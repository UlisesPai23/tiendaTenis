...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            //select nombre, contraseña, tipoUsuario from Usuarios where nombre='ulises';
            String url = "select nombre, contraseña, tipoUsuario from Usuarios where nombre='"+user+"'";
            try {
            ...
            if(rs.next()){
                ...
                if(pass != null && pass.equals(p)){
                    //Vamos a alumno o docente
